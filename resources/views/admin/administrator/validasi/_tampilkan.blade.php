...
<script>
    ...
    function tampilkanPengaturan(e) {
        ...
        document.getElementById("view-status").innerHTML = '<span class="badge bg-label-primary me-1">Not Validated</span>';
        } else if(e.isian_by_prodi.verifikasi == 1) {
        document.getElementById("view-status").innerHTML = '<span class="badge bg-label-success me-1">Accepted</span>';
        }else{
        document.getElementById("view-status").innerHTML = '<span class="badge bg-label-danger me-1">Rejected</span>';
        }

        // Menampilkan jawaban
        if (e.isian_by_prodi.jawaban == 1) {
        document.getElementById("view-jawaban").innerHTML = '<span class="badge bg-label-success me-1">Ada</span>';
        } else {
        document.getElementById("view-jawaban").innerHTML = '<span class="badge bg-label-warning me-1">Tidak Ada</span>';
        }
        ...
        document.getElementById("view-download").innerHTML = '<a href="/storage/'+(e.isian_by_prodi.dokumen1).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
        }else{
        ...
        document.getElementById("view-download-tambahan1").innerHTML = '<a href="/storage/'+(e.isian_by_prodi.dokumen2).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
        }else{
        ...
        document.getElementById("view-download-tambahan2").innerHTML = '<a href="/storage/'+(e.isian_by_prodi.dokumen3).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
        }else{
        ...
        document.getElementById("view-download-tambahan3").innerHTML = '<a href="/storage/'+(e.isian_by_prodi.dokumen4).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
        }else{
...
<script>
  function tampilkanPengaturanEvaluasitambahan(e) {
      ...
      //Menampilkan Download
      if (e.dokumen1 !== null ) {
      document.getElementById("view-download").innerHTML = '<a href="/storage/'+(e.dokumen1).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
      }else{
      document.getElementById("view-download").innerText = '';
      }
      ...
      //Menampilkan Download Tambahan 1
      if (e.dokumen2 !== null ) {
      document.getElementById("view-download-tambahan1").innerHTML = '<a href="/storage/'+(e.dokumen2).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
      }else{
      document.getElementById("view-download-tambahan1").innerText = '';
      }
      ...
      //Menampilkan Download Tambahan 2
      if (e.dokumen3 !== null) {
      document.getElementById("view-download-tambahan2").innerHTML = '<a href="/storage/'+(e.dokumen3).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
      }else{
      document.getElementById("view-download-tambahan2").innerText = '';
      }
      ...
      //Menampilkan Download Tambahan 3
      if (e.dokumen4 !== null) {
      document.getElementById("view-download-tambahan3").innerHTML = '<a href="/storage/'+(e.dokumen4).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
      }else{
      document.getElementById("view-download-tambahan3").innerText = '';
      }
