      ...
      <table class="table table-striped">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            ...
            <td>{{ucwords($u->faculty['singkatan']) ?? ''}}</td>
            <td>
              <div class="progress">
            ...
            <td>
              <div class="d-inline-block text-nowrap">
                <a href="/admin/validasi/{{ Crypt::encryptString($u->kode) ?? '' }}"><button data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<span>Lihat Isian</span>" class="btn btn-sm btn-icon delete-record"><i class='bx bx-show'></i></button></a>
            </td>
          </tr>
          @endforeach
