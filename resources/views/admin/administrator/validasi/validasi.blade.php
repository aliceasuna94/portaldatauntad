                        ...
                        @if ($data->isian_by_prodi != null)
                            ...
                            @can('konfirmasi validasi')
                                <td style="width: 100px">
                                    <button type="button" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<span>Tampilkan & Validasi</span>" class="btn btn-sm btn-icon btn-primary" data-pengaturan="{{ $data }}" onclick="tampilkanPengaturan(this)">
