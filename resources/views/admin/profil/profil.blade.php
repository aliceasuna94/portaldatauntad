          ...
          <form id="formAccountSettings" method="POST" onsubmit="return false">
            <div class="row">
              ...
              <div class="mb-3 col-md-6">
                ...
                <input class="form-control" type="text" id="nilai" name="nilai" value="{{$profil->nilai ?? ''}}">
              </div>
  
              <div class="mb-3 col-md-6">
                <label for="berlaku" class="form-label">Akreditasi Berlaku Sampai</label>
                <input class="form-control" type="date" id="berlaku" name="berlaku" value="{{$profil->berlaku ?? ''}}">
              </div>
                ...
                <div class="input-group">
                  <input type="file" accept="application/pdf" class="form-control" id="skakreditasi" name="sk_akreditasi"  aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                    ...
                    @if ($profil->sk_akreditasi ?? '')
                        <a href="{{ Storage::url($profil->sk_akreditasi) }}" target="_blank"><button class="btn btn-primary" type="button"><span class="tf-icons bx bx-show"></button></a>   
                    @endif
              ...
              <div class="mb-3 col-md-6">
                ...
                <div class="input-group">
                  ...
                  @if ($profil->sk_akreditasi_internasional ?? '')
                        <a href="{{ Storage::url($profil->sk_akreditasi_internasional) }}" target="_blank"><button class="btn btn-primary" type="button"><span class="tf-icons bx bx-show"></button></a>   
                  @endif
