...
<script>
    ...
    function switchAda() {
        var adahtml = '<div class="row"> <div class="col mb-3"> <label for="html5-date-input" class="form-label">TERAKHIR LAKSANAKAN</label> <input class="form-control" type="date" name="tanggal" id="html5-date-input"> </div> </div> <div class="row"> <div class="col mb-3"> <label for="formFile1" class="form-label">UPLOAD PDF DOKUMEN ('+modalarray.berkas+')</label> <input class="form-control" type="file" id="formFile1" name="dokumen1" accept="application/pdf"> </div> </div> <div class="row"> <div class="col mb-3"><label for="formFile2" class="form-label">DOKUMEN PDF TAMBAHAN (OPSIONAL)</label> <input class="form-control" type="file" id="formFile2" name="dokumen2"> </div> </div> <div class="row"> <div class="col mb-3"> <input class="form-control" type="file" id="formFile3" name="dokumen3"> </div> </div> <div class="row"> <div class="col mb-3"> <input class="form-control" type="file" id="formFile4" name="dokumen4"> </div> </div><input type="text" name="subpengaturan_id" value="'+modalarray.id+'" hidden>';
        ...
        <div class="mt-3" id="modalfortambah">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                          <label for="formFile1" class="form-label">UPLOAD PDF DOKUMEN</label>
                          <input class="form-control" type="file" id="formFile1" name="dokumen1" accept="application/pdf">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                          <label for="formFile2" class="form-label">DOKUMEN PDF TAMBAHAN (OPSIONAL)</label>
                          <input class="form-control" type="file" id="formFile2" name="dokumen2">
                    </div>
                    </div>
                      <div class="row">
                        <div class="col mb-3">
                          <input class="form-control" type="file" id="formFile3" name="dokumen3">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
                          <input class="form-control" type="file" id="formFile4" name="dokumen4">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
