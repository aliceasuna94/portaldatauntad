...
<script>
    function tampilkanPengaturan(e) {
        ...
        document.getElementById("view-download").innerHTML = '<a href="/storage/'+(e.isian.dokumen1).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
        }else{
        ...
        document.getElementById("view-download-tambahan1").innerHTML = '<a href="/storage/'+(e.isian.dokumen2).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
        }else{
        ...
        document.getElementById("view-download-tambahan2").innerHTML = '<a href="/storage/'+(e.isian.dokumen3).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
        }else{
        ...
        document.getElementById("view-download-tambahan3").innerHTML = '<a href="/storage/'+(e.isian.dokumen4).replace('public/','')+'"><button type="button" class="btn btn-xs btn-danger">Download</button></a>';
        }else{
